...
const prefix = '.'
const ownerNumber = ['94742053080'] // ★★★★★ OWNER NUMBER - වෙනස් කරන ලදී ★★★★★
//===================SESSION============================
...
async function connectToWA() {
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            // ★★★★★ STARTUP MESSAGE ★★★★★
            let up = `*𝐻𝒶𝓃𝓈𝒶𝓀𝒶 𝐹𝑒𝓇𝓃𝒶𝓃𝒹𝑜'𝓈 𝗔𝗜 𝗦𝗲𝗰𝗿𝗲𝘁𝗮𝗿𝘆 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱!* ✅ 

🌟 *Welcome, Mr. Hansaka Fernando!* 🌟
...
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/gxgikz.jpg` }, caption: up })
    ...
    conn.ev.on('messages.upsert', async (mek) => {
        try {
            ...
            const developers = '94742053080' // ★★★★★ DEVELOPER NUMBER - වෙනස් කරන ලදී ★★★★★
...
const ownerdata = {
    ...
    button: "CLICK ME",
    footer: "Powered by Mr. Hansaka Fernando", // ★★★★★ FOOTER ★★★★★
    buttonurl: "https://dtz-zone.vercel.app" // ★★★ ඔබට අවශ්‍ය නම් මෙම link එක වෙනස් කරන්න ★★★
}
...
// ★★★★★ SERVER MESSAGES ★★★★★
app.get("/", (req, res) => {
    res.send("🚀 Hansaka Fernando's AI Secretary Bot is Running!");
});
app.listen(port, () => console.log(`🚀 AI Secretary Bot listening on port http://localhost:${port}`)); 
